...
var _db = new SchoolContext();

// add-migration NameMigration -- создание миграции
// update-database -- обновление БД до ПОСЛЕДНЕЙ добавленной миграции
// update-database -migration:InitialCreate -- обновление до конкретной миграции
// remove migration -- удаление последней добавленной миграции

var courseService = new CourseServices(_db);
var instructorService = new InstructorServices(_db);
        ...
        "4) Добавить отзыв");
            ...
            switch (numberOfAdd)
            {
                ...
                case "2":
                    ...
                    await instructorService.AddAsync(instructor);
                    break;
        ...
        "4) Удалить отзыв");
            ...
            switch (numberOfRemove)
            {
                ...
                case "2":
                    ...
                    await instructorService.RemoveAsync(instructor);
                    break;
        ...
        "4) Показать отзыв");
            ...
            switch (numberOfShow)
            {
                ...
                case "2":
                    ...
                    await instructorService.GetAllAsync();
                    break;
